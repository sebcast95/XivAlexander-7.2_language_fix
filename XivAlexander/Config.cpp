...
static const std::map<Sqex::Language, WORD> GameLanguageIdMap{
	...
	{Sqex::Language::TraditionalChinese, MAKELANGID(LANG_TRADITIONAL_CHINESE, SUBLANG_TRADITIONAL_CHINESE)},
};
static const std::map<WORD, int> LanguageIdNameResourceIdMap{
	...
	{MAKELANGID(LANG_TRADITIONAL_CHINESE, SUBLANG_TRADITIONAL_CHINESE), IDS_LANGUAGE_NAME_TRADITIONAL_CHINESE},
};
